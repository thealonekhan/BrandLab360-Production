        ...
        <div class="tab-pane active" id="campaign" role="tabpanel">
            <table class="table table-responsive-sm table-bordered">
                ...
                <tr>
                    ...
                    <th>{{$gaAcquisitionCampaign->totalsForAllResults['ga:bounceRate']}}</th>
                    <th>{{$gaAcquisitionCampaign->totalsForAllResults['ga:avgSessionDuration']}}</th>
                </tr>
                </thead>
                <tbody>
        ...
        <div class="tab-pane" id="source" role="tabpanel">
            <table class="table table-responsive-sm table-bordered">
                ...
                <tr>
                    ...
                    <th>{{$gaAcquisitionSource->totalsForAllResults['ga:bounceRate']}}</th>
                    <th>{{$gaAcquisitionSource->totalsForAllResults['ga:avgSessionDuration']}}</th>
                </tr>
                </thead>
                <tbody>
        ...
        <div class="tab-pane" id="medium" role="tabpanel">
            <table class="table table-responsive-sm table-bordered">
                ...
                <tr>
                    ...
                    <th>{{$gaAcquisitionMedium->totalsForAllResults['ga:bounceRate']}}</th>
                    <th>{{$gaAcquisitionMedium->totalsForAllResults['ga:avgSessionDuration']}}</th>
                </tr>
                </thead>
                <tbody>
